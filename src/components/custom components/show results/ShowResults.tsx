  ...
  const getGameData = async () => {
    ...
    if (props.type === "category") {
      if (param.category === "All Games") {
        api = `https://gamestore-api-8t9b.onrender.com/get-all-games/${page}`;
      } else {
        api = `https://gamestore-api-8t9b.onrender.com/get-categoty-games/${param.category}/${page}`;
      }
    }

    if (props.type === "discount") {
      api = `https://gamestore-api-8t9b.onrender.com/get-all-discount/${page}`;
    }

    if (props.type === "search") {
      api = `https://gamestore-api-8t9b.onrender.com/search-all-games/${param.search_key}/${page}`;
    }
